...
def check_access(log, pas: str) -> bool:
    ...
    with open('HW008/users.txt', "r", encoding="utf-8") as users_file:
...
if not flag:
    ...
    users_list = my.file_to_dct("HW008/users.txt", "utf-8", ";")
...
while flag:
    ...
    if choise == 11:
        ...
        hw_file = open("HW008/hw.txt", "r", encoding="utf-8") 
        ...
        users_file = open("HW008/users.txt", "r", encoding="utf-8") 
